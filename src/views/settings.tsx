  ...
  return (
    <div className="p-6 max-w-[1000px] mx-auto space-y-4">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-0.5">Gestiona las preferencias de la aplicación</p>
      </div>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            <Bell className="w-4 h-4 text-slate-500" /> Notificaciones
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-0 space-y-3">
          {notifications.map(n => {
            const Icon = n.icon;
            return (
              <div key={n.id} className="flex items-center justify-between p-3 rounded-md border border-slate-200">
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            <Palette className="w-4 h-4 text-slate-500" /> Preferencias de visualización
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-0 space-y-3">
          ...
          <div className="flex items-center justify-between p-3 rounded-md border border-slate-200">
            <div>
              <div className="text-sm font-medium text-slate-900">Modo oscuro</div>
              <div className="text-[11px] text-slate-500 mt-0.5">Cambiar la apariencia de la interfaz</div>
            </div>
            <Switch />
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            <Building2 className="w-4 h-4 text-slate-500" /> Obras gestionadas
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-0 space-y-2">
          {obras.map(o => (
            <div key={o.id} className="flex items-center gap-3 p-3 rounded-md border border-slate-200">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-slate-500 mt-0.5">{o.client} · {o.address}</div>
              </div>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            <Database className="w-4 h-4 text-slate-500" /> Datos
          </CardTitle>
        </CardHeader>
        <CardContent className="pt-0 space-y-2">
          <div className="flex items-center justify-between p-3 rounded-md border border-slate-200">
            <div>
              <div className="text-sm font-medium text-slate-900">Exportar datos</div>
              <div className="text-[11px] text-slate-500 mt-0.5">Descargar todas las obras, tareas y configuraciones</div>
            </div>
            <Button variant="outline" size="sm"><Download className="w-3.5 h-3.5 mr-1" /> Exportar JSON</Button>
          </div>
          <div className="flex items-center justify-between p-3 rounded-md border border-red-200 bg-red-50">
            <div>
              <div className="text-sm font-medium text-red-900">Reiniciar todos los datos</div>
              <div className="text-[11px] text-red-700 mt-0.5">Restablecer a los datos de demostración (no se puede deshacer)</div>
            </div>
            <Button
              variant="outline"
              size="sm"
